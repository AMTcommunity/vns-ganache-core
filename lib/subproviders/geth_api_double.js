...
GethApiDouble.prototype.requiresDefaultBlockParameter = function(method) {
  ...
  var methods = {
    "vns_getBalance": true,
    "vns_getCode": true,
    "vns_getTransactionCount": true,
    "vns_getStorageAt": true,
    "vns_call": true,
    "vns_estimateGas": true
  };
...
GethApiDouble.prototype.vns_accounts = function(callback) {
  callback(null, Object.keys(this.state.accounts));
};

GethApiDouble.prototype.vns_blockNumber = function(callback) {
...
GethApiDouble.prototype.vns_coinbase = function(callback) {
  callback(null, this.state.coinbase);
};

GethApiDouble.prototype.vns_mining = function(callback) {
  callback(null, this.state.is_mining);
};

GethApiDouble.prototype.vns_hashrate = function(callback) {
  callback(null, '0x0');
};

GethApiDouble.prototype.vns_gasPrice = function(callback) {
  callback(null, utils.addHexPrefix(this.state.gasPrice()));
};

GethApiDouble.prototype.vns_getBalance = function(address, block_number, callback) {
  this.state.getBalance(address, block_number, callback);
};

GethApiDouble.prototype.vns_getCode = function(address, block_number, callback) {
  this.state.getCode(address, block_number, callback);
};

GethApiDouble.prototype.vns_getBlockByNumber = function(block_number, include_full_transactions, callback) {
...
GethApiDouble.prototype.vns_getBlockByHash = function(tx_hash, include_full_transactions, callback) {
  this.vns_getBlockByNumber.apply(this, arguments);
};

GethApiDouble.prototype.vns_getBlockTransactionCountByNumber = function(block_number, callback) {
  this.state.blockchain.getBlock(block_number, function(err, block) {
    if (err) {
...
GethApiDouble.prototype.vns_getBlockTransactionCountByHash = function(block_hash, callback) {
  this.vns_getBlockTransactionCountByNumber.apply(this, arguments);
}

GethApiDouble.prototype.vns_getTransactionReceipt = function(hash, callback) {
...
GethApiDouble.prototype.vns_getTransactionByHash = function(hash, callback) {
  this.state.getTransactionReceipt(hash, function(err, receipt) {
    if (err) return callback(err);
...
GethApiDouble.prototype.vns_getTransactionByBlockHashAndIndex = function(hash_or_number, index, callback) {
  var self = this;
...
GethApiDouble.prototype.vns_getTransactionByBlockNumberAndIndex = function(hash_or_number, index, callback) {
  this.vns_getTransactionByBlockHashAndIndex(hash_or_number, index, callback);
};

GethApiDouble.prototype.vns_getTransactionCount = function(address, block_number, callback) {
  this.state.getTransactionCount(address, block_number, callback);
}

GethApiDouble.prototype.vns_sign = function(address, dataToSign, callback) {
  var result;
  var error;
...
GethApiDouble.prototype.vns_sendTransaction = function(tx_data, callback) {
  this.state.queueTransaction("vns_sendTransaction", tx_data, null, callback);
};

GethApiDouble.prototype.vns_sendRawTransaction = function(rawTx, callback) {
  this.state.queueRawTransaction(rawTx, callback);
};

GethApiDouble.prototype.vns_call = function(tx_data, block_number, callback) {
  if (!tx_data.gas) {
    tx_data.gas = this.state.blockchain.blockGasLimit;
  }

  this.state.queueTransaction("vns_call", tx_data, block_number, callback); // :(
};

GethApiDouble.prototype.vns_estimateGas = function(tx_data, block_number, callback) {
  if (!tx_data.gas) {
    tx_data.gas = this.state.blockchain.blockGasLimit;
  }
  this.state.queueTransaction("vns_estimateGas", tx_data, block_number, callback);
};

GethApiDouble.prototype.vns_getStorageAt = function(address, position, block_number, callback) {
  this.state.queueStorage(address, position, block_number, callback);
};

GethApiDouble.prototype.vns_newBlockFilter = function(callback) {
...
GethApiDouble.prototype.vns_getFilterChanges = function(filter_id, callback) {
...
GethApiDouble.prototype.vns_getLogs = function(filter, callback) {
  this.state.getLogs(filter, callback);
};

GethApiDouble.prototype.vns_uninstallFilter = function(filter_id, callback) {
  callback(null, true);
};

GethApiDouble.prototype.vns_protocolVersion = function(callback) {
  callback(null, "63");
};
...
GethApiDouble.prototype.vns_getCompilers = function(callback) {
  callback(null, ["solidity"]);
}

GethApiDouble.prototype.vns_syncing = function(callback) {
  callback(null, false);
};
...
GethApiDouble.prototype.rpc_modules = function(callback) {
  ...
  callback(null, {"vns":"1.0","net":"1.0","rpc":"1.0","web3":"1.0","evm":"1.0","personal":"1.0"});
};
...
GethApiDouble.prototype.personal_sendTransaction = function(tx_data, password, callback) {
  ...
  self.personal_unlockAccount(from, password, null, function(err) {
    ...
    self.state.queueTransaction("vns_sendTransaction", tx_data, null, function(err, ret) {
