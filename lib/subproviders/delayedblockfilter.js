...
DelayedBlockFilter.prototype.handleRequest = function(payload, next, end) {
  if (payload.method == "vns_newBlockFilter") return this.handleNewBlockFilter(payload, next, end);
  if (payload.method == "vns_getFilterChanges") return this.handleGetFilterChanges(payload, next, end);
